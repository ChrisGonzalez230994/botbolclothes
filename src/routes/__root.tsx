  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TU MARCA · Moda femenina con estilo — Mar del Plata" },
      {
        ...
        content:
          "Moda femenina desde Mar del Plata, Argentina. Calidad, estilo y cercanía.",
      },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/40b7713e-54c3-4e15-a57b-1e71db803bad" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/40b7713e-54c3-4e15-a57b-1e71db803bad" },
    ],
    links: [
